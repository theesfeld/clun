...
`0.2.0-dev.7` / `v0.2.0-dev.7` under Issues #216 and #252. SemVer impact remains `major` for the
...
Issue #331 stages free stable patch `0.2.2` / `v0.2.2` after published `v0.2.1`: `clun --update` installs packaged man into the XDG man path (parity with `site/install`). SemVer impact is `patch`. Installer default remains `v0.2.1` until `v0.2.2` assets publish.
