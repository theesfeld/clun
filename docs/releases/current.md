...
The public router row remains `No` while four-target receipts and final adversarial review are pending.
README, landing page, ledger, and Issue #24 will promote together only after those gates pass.
