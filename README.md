...
| Jest-compatible test runner | Partial: 62 core and extended matchers, external and inline snapshot lifecycles, custom and Promise-settlement asymmetric matchers, mocks/spies, callbacks, per-test cleanup, parameterization, retries, and repeats | [Phase 66](https://github.com/theesfeld/clun/issues?q=is%3Aissue%20label%3Aphase-66) |
