...
While the hosted boundary remains `v0.2.1`, that command only reinstalls `v0.2.1` and does not
activate the `0.2.2` candidate until `v0.2.2` assets publish. The candidate fixes man install on `clun --update`.
