...
> **Status: pre-alpha, under active construction.** [Phase 33](https://github.com/theesfeld/clun/issues/7) is in progress.
> Its release-bearing target is `0.1.0-dev.10` / `v0.1.0-dev.10` (SemVer impact: `minor`).
> The verified release boundary is `v0.1.0-dev.9`, with four native archives, checksums, Pages,
...
The current source is the `0.1.0-dev.10` release candidate; the immutable tag and assets are not published yet.
The last published prerelease remains [`v0.1.0-dev.9`](https://github.com/theesfeld/clun/releases/tag/v0.1.0-dev.9).
...
[Phase 33 issue #7](https://github.com/theesfeld/clun/issues/7) is the canonical live release record.
...
./build/clun --version   # => clun 0.1.0-dev.10
```
