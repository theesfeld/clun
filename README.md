...
| Cross-platform shell API | Partial: `Clun.$` pipelines, redirects, builtins, isolated assignments, exact `cp`/`echo`/`seq`, and 311/1,630 pinned shell sites | [Phase 65](https://github.com/theesfeld/clun/issues?q=is%3Aissue%20label%3Aphase-65) |
