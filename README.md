...
| Cross-platform shell API | Partial: `Clun.$` pipelines, grouped subshells, `if` control flow, pre-opened file redirects, builtins, isolated assignments, exact core filesystem commands, and 676/1,630 pinned shell sites | [Phase 65](https://github.com/theesfeld/clun/issues?q=is%3Aissue%20label%3Aphase-65) |
