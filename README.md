...
| Jest-compatible test runner | Partial: 62 core and extended matchers, snapshot lifecycles with stable property tokens, custom and Promise-settlement asymmetric matchers, per-realm ESM/CJS module mocks, seeded Bun-pinned randomization, deterministic file sharding, dots and JUnit reporters, function mocks/spies, callbacks, cleanup, parameterization, retries, and repeats | [Phase 66](https://github.com/theesfeld/clun/issues?q=is%3Aissue%20label%3Aphase-66) |
