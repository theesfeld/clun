...
| Cross-platform shell API | Partial: `Clun.$` pipelines, redirects, builtins, isolated assignments, brace-plus-glob composition, and 178/1,630 exact pinned shell sites | [Phase 65](https://github.com/theesfeld/clun/issues?q=is%3Aissue%20label%3Aphase-65) |
