...
> The verified release boundary is `v0.1.0-dev.13`, with four native archives and checksums.
...
The current source version and latest published prerelease are [`0.1.0-dev.13`](https://github.com/theesfeld/clun/releases/tag/v0.1.0-dev.13).
...
./build/clun --version   # => clun 0.1.0-dev.13
```
