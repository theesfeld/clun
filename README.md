...
> Published release: `0.2.0-dev.8` / `v0.2.0-dev.8` (SemVer impact: `minor`).
> The verified release boundary is `v0.2.0-dev.8`, with four native archives and checksums.
...
The current source version and latest published prerelease are [`0.2.0-dev.8`](https://github.com/theesfeld/clun/releases/tag/v0.2.0-dev.8).
