...
> **Status: pre-alpha, under active construction.** [Phase 66](https://github.com/theesfeld/clun/issues/127) is in progress.
> Its release-bearing target is `0.1.0-dev.36` / `v0.1.0-dev.36` (SemVer impact: `minor`).
...
The current source is the `0.1.0-dev.36` release candidate; the immutable tag and assets are not published yet.
...
[Phase 66 issue #127](https://github.com/theesfeld/clun/issues/127) is the canonical live release record.
...
./build/clun --version   # => clun 0.1.0-dev.36
```
