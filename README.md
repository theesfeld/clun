...
| Cross-platform shell API | Partial: `Clun.$`, `clun exec`, pipelines, grouped subshells, `if` control flow, Blob/Response I/O, pre-opened file redirects, builtins, isolated assignments, exact core filesystem commands, and 744/1,630 pinned shell sites | [Phase 65](https://github.com/theesfeld/clun/issues?q=is%3Aissue%20label%3Aphase-65) |
