...
**8/8** shipped `tooling.shell` evidence records; `make build`, `make purity` (**716 / 0**), and diff check
pass. The exact stable and engineering Bun boundary is now frozen at **211 source/docs/types/test files** and
**1,630 lexical test sites**: **311 covered / 1,287 pending / 32 upstream-inactive**. The checked-in coverage
