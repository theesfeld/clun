         ...
         (code
           (handler-case
             ...
             (bad-cwd (c)
               ...
               2)
             ;; SIGINT / Ctrl-C — serious-condition but not ERROR; never dump a Lisp
             ;; backtrace without --backtrace (Phase 26 hardening).
             (sb-sys:interactive-interrupt ()
               (cli:emit-err "interrupted")
               (ignore-errors (rt:run-exit-handlers 130))
               130)
             (storage-condition ()
