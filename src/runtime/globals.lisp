...
(defun install-globals (realm)
  (let ((eng:*realm* realm) (g (eng:realm-global realm)))
    ...
    (install-web-http realm)                ; Headers/Request/Response/Streams (Phase 17/38)
    (install-web-platform realm)            ; residual Web Standard surface (#207)
    ...
    (install-websocket-global g)))          ; WebSocket client (Phase 51)
