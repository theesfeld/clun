...
while IFS= read -r changed_path; do
  case $changed_path in
    src/*|vendor/*|vendor-data/*|clun.asd|site/install|scripts/release/*|scripts/build.lisp|scripts/registry.lisp|Makefile|.github/workflows/release.yml|LICENSE|THIRD_PARTY_NOTICES.md)
