...
Clun is MIT. Its source distribution also contains vendored,
license-compatible Common Lisp components under `vendor/` and Unicode data under
...
to each component's own license terms.
